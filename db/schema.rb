...
ActiveRecord::Schema.define(version: 20150714100942) do

  create_schema "radioactive_oasis_2243"
  ...
  create_table "radioactive_oasis_2243.embed_entities", force: true do |t|
    t.integer  "embed_id"
    t.integer  "entity_id"
    t.boolean  "is_approved_manually"
    t.boolean  "is_pinned",                 default: false, null: false
  ...
  add_index "radioactive_oasis_2243.embed_entities", ["entity_id"], :name => "embed_entities_entity_id_idx"

  create_table "radioactive_oasis_2243.embed_presets", force: true do |t|
    t.integer  "embed_id"
    t.string   "name"
    t.json     "config"
    t.datetime "created_at"
  ...
  create_table "radioactive_oasis_2243.embeds", force: true do |t|
    t.string  "name"
    t.integer "brand_id"
    t.boolean "approved_by_default", default: true
    t.boolean "published",           default: false
...
# Could not dump table "radioactive_oasis_2243.entities" because of following NoMethodError
#   undefined method `[]' for nil:NilClass

  create_table "radioactive_oasis_2243.events", force: true do |t|
    t.string   "type_name"
    t.string   "feed_name"
    t.string   "content_digest"
    t.hstore   "props",          default: {}
  ...
  add_index "radioactive_oasis_2243.events", ["content_digest"], :name => "index_events_on_content_digest"

  create_table "radioactive_oasis_2243.filters", force: true do |t|
    t.integer "embed_id"
    t.string  "action",   null: false
  end

  create_table "radioactive_oasis_2243.histogram", id: false, force: true do |t|
    t.string   "source_type"
    t.integer  "source_id"
    t.integer  "volume"
    t.integer  "delta"
  ...
  add_index "radioactive_oasis_2243.histogram", ["source_type", "source_id", "measured_at"], :name => "histogram_unique_source_measured_at", :unique => true

  create_table "radioactive_oasis_2243.interactions", id: false, force: true do |t|
    t.string   "event_type"
    t.string   "event_subtype"
    t.integer  "primary_source_id"
    t.string   "primary_source_type"
  ...
  create_table "radioactive_oasis_2243.natlang_queries", force: true do |t|
    t.string  "attr_name"
    t.string  "op"
    t.string  "val"
    t.boolean "is_negated", default: false
  ...
  create_table "radioactive_oasis_2243.ownerships", force: true do |t|
    t.integer  "owner_id"
    t.integer  "entity_id"
    t.integer  "value"
    t.string   "ownership_type"
  ...
  create_table "radioactive_oasis_2243.schema_migrations", id: false, force: true do |t|
    t.string "version", null: false
  end

  add_index "radioactive_oasis_2243.schema_migrations", ["version"], :name => "unique_schema_migrations", :unique => true

  create_table "radioactive_oasis_2243.service_entities", force: true do |t|
    t.integer "service_id"
    t.integer "entity_id"
  end

  add_index "radioactive_oasis_2243.service_entities", ["entity_id", "service_id"], :name => "index_service_entities_on_entity_id_and_service_id"
  add_index "radioactive_oasis_2243.service_entities", ["entity_id"], :name => "service_entities_entity_id_idx"
  add_index "radioactive_oasis_2243.service_entities", ["service_id"], :name => "index_service_entities_on_service_id"

  create_table "radioactive_oasis_2243.service_errors", force: true do |t|
    t.string   "klass"
    t.string   "message"
    t.text     "backtrace"
    t.integer  "service_id"
  ...
  create_table "radioactive_oasis_2243.services", force: true do |t|
    t.integer  "embed_id"
    t.string   "feed_name"
    t.string   "type_name"
    t.json     "config"
  ...
  create_table "radioactive_oasis_2243.taggings", force: true do |t|
    t.integer  "tag_id"
  ...
  add_index "radioactive_oasis_2243.taggings", ["tag_id", "taggable_id", "taggable_type", "context", "tagger_id", "tagger_type"], :name => "taggings_idx", :unique => true

  create_table "radioactive_oasis_2243.tags", force: true do |t|
    t.string  "name",                        null: false
    t.string  "display_name"
  ...
  add_index "radioactive_oasis_2243.tags", ["name"], :name => "index_tags_on_name", :unique => true
...
#   undefined method `[]' for nil:NilClass
  ...
  GROUP BY e.id;
  SQL
  create_view "radioactive_oasis_2243.entity_aggregated_tag_list", <<-SQL
     SELECT e.id AS entity_id,
    string_agg((t.name)::text, ','::text) AS tag_list
   FROM radioactive_oasis_2243.entities e,
    radioactive_oasis_2243.tags t,
    radioactive_oasis_2243.taggings e_t
  WHERE ((e.id = e_t.taggable_id) AND (e_t.tag_id = t.id))
  GROUP BY e.id;
  SQL
