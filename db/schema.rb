...
ActiveRecord::Schema.define(version: 20160524161532) do
  ...
  add_index "bits", ["feed_name"], name: "entities_feed_name_idx", using: :gin
  add_index "bits", ["origin_id"], name: "entities_origin_id_idx", using: :btree
  add_index "bits", ["parent_id"], name: "entities_parent_id_idx", using: :btree
  add_index "bits", ["type_name"], name: "entities_type_name_idx", using: :gin
  ...
  add_index "events", ["bit_id"], name: "events_entity_id_idx", using: :btree
  ...
  create_table "hub_embeds", force: :cascade do |t|
    t.integer  "hub_id"
    t.string   "name"
    t.json     "config"
    t.datetime "created_at"
  ...
  create_table "hub_events", force: :cascade do |t|
    t.integer  "organization_id"
    t.integer  "brand_id"
    t.integer  "hub_id"
  ...
  add_index "moderations", ["bit_id"], name: "embed_entities_entity_id_idx", using: :btree
  ...
  create_table "service_bits", force: :cascade do |t|
    t.integer "service_id"
    t.integer "bit_id"
  end

  add_index "service_bits", ["bit_id", "service_id"], name: "index_service_bits_on_bit_id_and_service_id", using: :btree
  add_index "service_bits", ["bit_id"], name: "service_entities_entity_id_idx", using: :btree
  add_index "service_bits", ["service_id"], name: "index_service_bits_on_service_id", using: :btree
  ...
  add_index "user_organizations", ["user_id", "organization_id"], name: "no_double_links", unique: true, using: :btree
  ...
  add_foreign_key "events", "bits", name: "fk_events_to_entities", on_delete: :cascade
  add_foreign_key "filters", "hubs", name: "fk_filters_to_embeds", on_delete: :cascade
  add_foreign_key "hub_embeds", "hubs", name: "fk_embed_presets_to_embeds", on_delete: :cascade
  add_foreign_key "moderations", "bits", name: "fk_embed_entities_to_entities", on_delete: :cascade
  add_foreign_key "moderations", "hubs", name: "fk_embed_entities_to_embeds", on_delete: :cascade
  add_foreign_key "natlang_queries", "filters", name: "fk_natlang_queries_to_filters", on_delete: :cascade
  add_foreign_key "service_bits", "bits", name: "fk_service_entities_to_entities", on_delete: :cascade
  add_foreign_key "service_bits", "services", name: "fk_service_entities_to_services", on_delete: :cascade
