...
ActiveRecord::Schema.define(version: 20150602135248) do
  ...
  create_schema "billowing_crater_8916"
  ...
  create_table "billowing_crater_8916.accounts_brands", id: false, force: true do |t|
    t.integer "brand_id",   null: false
    t.integer "account_id", null: false
  end

  add_index "billowing_crater_8916.accounts_brands", ["account_id", "brand_id"], :name => "index_accounts_brands_on_account_id_and_brand_id"
  add_index "billowing_crater_8916.accounts_brands", ["account_id"], :name => "index_accounts_brands_on_account_id"
  add_index "billowing_crater_8916.accounts_brands", ["brand_id", "account_id"], :name => "index_accounts_brands_on_brand_id_and_account_id"
  add_index "billowing_crater_8916.accounts_brands", ["brand_id"], :name => "index_accounts_brands_on_brand_id"

  create_table "billowing_crater_8916.embed_entities", force: true do |t|
    t.integer  "embed_id"
    t.integer  "entity_id"
  ...
  create_table "billowing_crater_8916.embed_presets", force: true do |t|
    t.integer  "embed_id"
    t.string   "name"
    t.json     "config"
    t.datetime "created_at"
  ...
  create_table "billowing_crater_8916.embeds", force: true do |t|
    t.string  "name"
    t.integer "brand_id"
  ...
  add_index "billowing_crater_8916.embeds", ["brand_id"], :name => "index_embeds_on_brand_id"

# Could not dump table "billowing_crater_8916.entities" because of following NoMethodError
#   undefined method `[]' for nil:NilClass

  create_table "billowing_crater_8916.events", force: true do |t|
    t.string   "type_name"
    t.string   "feed_name"
  ...
  add_index "billowing_crater_8916.events", ["content_digest"], :name => "index_events_on_content_digest"

  create_table "billowing_crater_8916.filters", force: true do |t|
    t.integer "embed_id"
    t.string  "action",   null: false
  end

  create_table "billowing_crater_8916.histogram", id: false, force: true do |t|
  ...
  add_index "billowing_crater_8916.histogram", ["source_type", "source_id", "measured_at"], :name => "histogram_unique_source_measured_at", :unique => true

  create_table "billowing_crater_8916.interactions", id: false, force: true do |t|
    t.string   "event_type"
  ...
  create_table "billowing_crater_8916.natlang_queries", force: true do |t|
    t.string  "attr_name"
    t.string  "op"
    t.string  "val"
  ...
  create_table "billowing_crater_8916.ownerships", force: true do |t|
    t.integer  "owner_id"
    t.integer  "entity_id"
    t.integer  "value"
  ...
  add_index "billowing_crater_8916.ownerships", ["entity_id"], :name => "index_ownerships_on_entity_id"
  add_index "billowing_crater_8916.ownerships", ["owner_id"], :name => "index_ownerships_on_owner_id"

  create_table "billowing_crater_8916.schema_migrations", id: false, force: true do |t|
    t.string "version", null: false
  end

  add_index "billowing_crater_8916.schema_migrations", ["version"], :name => "unique_schema_migrations", :unique => true

  create_table "billowing_crater_8916.service_entities", force: true do |t|
    t.integer "service_id"
    t.integer "entity_id"
  end

  add_index "billowing_crater_8916.service_entities", ["entity_id", "service_id"], :name => "index_service_entities_on_entity_id_and_service_id"
  add_index "billowing_crater_8916.service_entities", ["service_id"], :name => "index_service_entities_on_service_id"

  create_table "billowing_crater_8916.service_errors", force: true do |t|
    t.string   "klass"
    t.string   "message"
    t.text     "backtrace"
    t.integer  "service_id"
  ...
  create_table "billowing_crater_8916.services", force: true do |t|
    t.integer  "embed_id"
    t.string   "feed_name"
    t.string   "type_name"
    t.json     "config"
  ...
  add_index "billowing_crater_8916.services", ["embed_id"], :name => "index_services_on_embed_id"

  create_table "billowing_crater_8916.taggings", force: true do |t|
    t.integer  "tag_id"
  ...
  add_index "billowing_crater_8916.taggings", ["tag_id", "taggable_id", "taggable_type", "context", "tagger_id", "tagger_type"], :name => "taggings_idx", :unique => true

  create_table "billowing_crater_8916.tags", force: true do |t|
  ...
  add_index "billowing_crater_8916.tags", ["name"], :name => "index_tags_on_name", :unique => true
...
#   undefined method `[]' for nil:NilClass
  ...
  create_view "billowing_crater_8916.entity_aggregated_tag_list", <<-SQL
     SELECT e.id AS entity_id,
    string_agg((t.name)::text, ','::text) AS tag_list
   FROM billowing_crater_8916.entities e,
    billowing_crater_8916.tags t,
    billowing_crater_8916.taggings e_t
  ...
  add_foreign_key "billowing_crater_8916.accounts_brands", "public.accounts", :name => "accounts_brands_account_id_fk", :column => "account_id", :dependent => :delete, :exclude_index => true
  add_foreign_key "billowing_crater_8916.accounts_brands", "public.brands", :name => "accounts_brands_brand_id_fk", :column => "brand_id", :dependent => :delete, :exclude_index => true

  add_foreign_key "billowing_crater_8916.embeds", "public.brands", :name => "embeds_brand_id_fk", :column => "brand_id", :dependent => :delete, :exclude_index => true

  add_foreign_key "billowing_crater_8916.ownerships", "billowing_crater_8916.entities", :name => "ownerships_entity_id_fk", :column => "entity_id", :dependent => :delete, :exclude_index => true
  add_foreign_key "billowing_crater_8916.ownerships", "public.users", :name => "ownerships_owner_id_fk", :column => "owner_id", :dependent => :delete, :exclude_index => true

  add_foreign_key "billowing_crater_8916.services", "billowing_crater_8916.embeds", :name => "services_embed_id_fk", :column => "embed_id", :dependent => :delete, :exclude_index => true
