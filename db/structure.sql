...
ALTER TABLE ONLY awards
    ADD CONSTRAINT fk_awards_users FOREIGN KEY (actor_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY internals
    ADD CONSTRAINT fk_internals_actor_users FOREIGN KEY (actor_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY internals
    ADD CONSTRAINT fk_internals_receiver_users FOREIGN KEY (receiver_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY ownerships
    ADD CONSTRAINT fk_ownerships_users FOREIGN KEY (owner_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY upvotes
    ADD CONSTRAINT fk_upvotes_users FOREIGN KEY (actor_id) REFERENCES public.users(id);
...
ALTER TABLE ONLY achievements
    ADD CONSTRAINT fk_users_rewards_users FOREIGN KEY (user_id) REFERENCES public.users(id);
