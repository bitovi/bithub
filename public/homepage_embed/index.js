...
var RealBit = Bit.extend({
	findAll: function(params){
		return $.ajax({
			url: window.location.protocol + '//bithub.com/api/v4/embeds/143/entities?view=public&decision=approved&tenant_name=calm_dove_6826&image_only=true&' + $.param(params)
		});
	},
}, {});
