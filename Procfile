...
crawler_poller: NEW_RELIC_APP_NAME="Crawler (Development)" ruby ./services/crawler/poller/kickstart.rb
crawler_listener: NEW_RELIC_APP_NAME="Crawler (Development)" ruby ./services/crawler/listener/kickstart.rb
