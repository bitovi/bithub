...
describe Events::Github::PushEvent do
  ...
  subject(:push) do
    Events::Github::PushEvent.new(raw_push).wrap_response
  end

  describe "#digest_seed" do
    it "should respond with digest seed constructed of event_id" do
      expect(push.digest_seed).to eq raw_push['id'] + "Events::Github::PushEvent"
    end
  end
