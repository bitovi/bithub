FactoryGirl.define do
  ...
  factory :bit do
    ...
    factory :bit_wo_type, traits: [:with_determined_feed, :with_determined_author]
    factory :bit_wo_feed, traits: [:with_determined_type, :with_determined_author]
    factory :bit_wo_author, traits: [:with_determined_type, :with_determined_feed]

    # Twitter bit
    
    factory :meetup_bit do
      feed_name 'meetup'
    ...
    factory :gitmoderation do
      ...
      factory :github_push do
        ...
        trait :with_push_bit_source_data do
          source_data(push_bit_source_data)
        end
      end
