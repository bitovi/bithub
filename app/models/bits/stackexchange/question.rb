    ...
    class Question < Protocol
      ...
      def build_answers
        @event.answers.map do |a| # Wrappers
          ...
          Bits::Stackexchange::Answer.new(a_e).procure.group.normalize.instance
      ...
      def build_comments
        @event.comments.map do |c| # Wrappers
          ...
          Bits::Stackexchange::Comment.new(c_e).procure.group.normalize.instance
      ...
      def update_answers
        @event.answers.map do |a| # Wrappers
          ...
          Bits::Stackexchange::Answer.new(a_e).procure.update.group.normalize.persist
        end if @event.answers
      end
