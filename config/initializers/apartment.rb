...
Apartment.configure do |config|
  config.excluded_models = %w(InviteCode Brand Credential User BrandsUser Organization UserOrganization UserRole UsersUserRole User Country Subscription Payment StripeWebhooksLog Plan HubEvent MonthlyBilling MonthlyBillingRecord)
