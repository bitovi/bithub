...
Apartment.configure do |config|
  config.excluded_models = %w(Brand BrandIdentity Account AccountsBrand AccountRole AccountsAccountRole User BrandsUser Country Subscription Payment StripeWebhooksLog)
