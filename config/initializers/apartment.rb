...
Apartment.configure do |config|
  config.excluded_models = %w(InviteCode Brand BrandIdentity Account Organization AccountOrganization AccountRole AccountAccountRole User BrandsUser Country Subscription Payment StripeWebhooksLog Plan)
